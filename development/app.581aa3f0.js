...
},{"core-js/library/fn/object/values":"../node_modules/@babel/runtime-corejs2/node_modules/core-js/library/fn/object/values.js"}],"../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
},{"regenerator-runtime":"../node_modules/regenerator-runtime/runtime.js"}],"../node_modules/@babel/runtime-corejs2/node_modules/core-js/library/modules/es6.object.to-string.js":[function(require,module,exports) {
...
var getVoices = /*#__PURE__*/function () {
...
var speak = function speak(text) {
  ...
  var voiceSelected = voiceSelect.selectedOptions[0].getAttribute('data-name');
  voices.forEach(function (voice) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 6;
            return _axios.default.post('http://localhost:3001/', {
              data: url
            });
    ...
    return _regenerator.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            agregatedText = cutTextTo200Char();
...
var cutTextTo200Char = function cutTextTo200Char(text) {
  var charNumber = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 200;
  var arrayTEXT = (0, _values.default)(TEXT2SPEECH);
  var re = new RegExp("^[\\s\\S]{".concat(Math.floor(charNumber / 2), ",").concat(charNumber, "}[.!?,]{1}|^[\\s\\S]{", 1, ",").concat(charNumber, "}$|^[\\s\\S]{", 1, ",").concat(charNumber, "}"));
  var fullText = arrayTEXT.reduce(function (prev, current, index) {
    var currentText = (0, _values.default)(current)[0];
    var actualIndex = prev.length - 1; //console.log(prev)
...
},{"@babel/runtime-corejs2/core-js/object/values":"../node_modules/@babel/runtime-corejs2/core-js/object/values.js","@babel/runtime-corejs2/regenerator":"../node_modules/@babel/runtime-corejs2/regenerator/index.js","@babel/runtime-corejs2/core-js/promise":"../node_modules/@babel/runtime-corejs2/core-js/promise.js","@babel/runtime-corejs2/helpers/asyncToGenerator":"../node_modules/@babel/runtime-corejs2/helpers/asyncToGenerator.js","axios":"../node_modules/axios/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
